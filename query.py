...
def do_query():
    ...
    # obj = 'Account'
    # query = f'select count(Id) from {obj} where Legacy_ID__c = null'
    ...
    # query = 'select count(Id) as Ct from Account where Pension_Analyst__c != null'
    # query = 'SELECT AccountId FROM Opportunity WHERE AccountId != null'

    # query = 'SELECT Id, Name FROM Account where Id IN (SELECT Opportunity.AccountId FROM Opportunity WHERE Opportunity.AccountId != null)'
    # query = 'SELECT Id, Name FROM Contact where AccountId IN (SELECT Opportunity.AccountId FROM Opportunity WHERE Opportunity.AccountId != null)'
    
    # query = 'select Plan_Code__r.Name, Contact_Name__c, Contact_Name__r.Name, Contact_Name__r.AccountId from Plan_Contact__c where Contact_Name__r.AccountId IN (\'0011U00000QS6t0QAD\', \'0011U00001GW1SHQA1\', \'0011U00001GXobXQAT\')'
    # query = 'select Plan_Code__r.Name, Contact_Name__c, Contact_Name__r.Name, Contact_Name__r.AccountId from Plan_Contact__c where Contact_Name__r.AccountId IN (SELECT Opportunity.AccountId FROM Opportunity WHERE Opportunity.AccountId != null)'

    # query = 'SELECT Id FROM Contact where AccountId IN (SELECT Opportunity.AccountId FROM Opportunity WHERE Opportunity.AccountId != null)'
    # query = 'select Plan_Code__r.Name, Contact_Name__c, Contact_Name__r.Name, Contact_Name__r.AccountId from Plan_Contact__c where Contact_Name__c IN (\'0031U00001CrNbpQAF\')'
    
    # query = 'select Plan_Code__r.Name, Contact_Name__r.Name, Contact_Name__r.AccountId from Plan_Contact__c where Contact_Name__c IN (SELECT Id FROM Contact where AccountId IN (SELECT Opportunity.AccountId FROM Opportunity WHERE Opportunity.AccountId != null))'
